...
function form(formSelector) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      (0,_services_services__WEBPACK_IMPORTED_MODULE_15__.postData)('mailer/smart.php', json).then(function (data) {
  ...
  function showThanksModal(message) {
    ...
    (0,_modal__WEBPACK_IMPORTED_MODULE_14__.openModal)('.modal');
    ...
    setTimeout(function () {
      ...
      (0,_modal__WEBPACK_IMPORTED_MODULE_14__.closeModal)('.modal');
    }, 2000);
  }
  ...
  function mask(event) {
    ...
    var reg = matrix.slice(0, this.value.length).replace(/_+/g, function (a) {
      return "\\d{1," + a.length + "}";
    }).replace(/[+()]/g, "\\$&");
    reg = new RegExp("^" + reg + "$");
...
function slider(container) {
  ...
  tnsControls.addEventListener('click', function (e) {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_slider__WEBPACK_IMPORTED_MODULE_1__["default"])('.slider__wrapper');
  ...
  (0,_modules_scrolltop__WEBPACK_IMPORTED_MODULE_4__["default"])();
});
})();
